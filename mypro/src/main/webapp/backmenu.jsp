						...
						<TBODY>
							<TR height=20>
								...
								<TD><A class=menuChild
									href="employeelistservlet" target="mainFrame">&nbsp;<font size=2>查看员工</font></A>
								</TD>
							</TR>
						...
						<TBODY>
							<TR height=20>
								...
								<TD><A class=menuChild
									...
									href="listuserservlet" target=mainFrame>&nbsp;<font size=2>查看用户</font></A>
								</TD>
							</TR>
							<TR height=4>
								<TD colSpan=2></TD>
					...
					<TABLE id=child3 style="DISPLAY: none" cellSpacing=0 cellPadding=0 width=150 border=0>
						<TBODY>
							<TR height=20>
								...
								<TD><A class=menuChild
									onclick="javascript:window.close();"
									href="addinfomation.jsp" target=mainFrame>&nbsp;<font size=2>增加动态</font></A>
								</TD>
							</TR>
							<TR height=20>
								<TD align=center width=30>
					...
					<TABLE id=child4 style="DISPLAY: none" cellSpacing=0 cellPadding=0 width=150 border=0>
						<TBODY>
							<TR height=20>
								...
								<TD><A class=menuChild
									onclick="javascript:window.close();"
									href="listprojectservlet" target=mainFrame>&nbsp;<font size=2>查看项目</font></A>
								</TD>
							</TR>
							...
							<TR height=20>
								...
								<TD><A class=menuChild
									onclick="javascript:window.close();"
									href="addproject.jsp" target=mainFrame>&nbsp;<font size=2>添加项目</font></A>
								</TD>
							</TR>
							...
							<TR height=20>
								...
								<TD><A class=menuChild
									onclick="javascript:window.close();"
									href="searchprojectservlet" target=mainFrame>&nbsp;<font size=2>查询项目</font></A>
								</TD>
							</TR>
					...
					<TABLE id=child5 style="DISPLAY: none" cellSpacing=0 cellPadding=0 width=150 border=0>
						<TBODY>
							<TR height=20>
								...
								<TD><A class=menuChild
									onclick="javascript:window.close();"
									href="listpolservlet" target=mainFrame>&nbsp;<font size=2>查看政策</font></A>
								</TD>
							</TR>
							...
							<TR height=20>
								...
								<TD><A class=menuChild
									onclick="javascript:window.close();"
									href="addpolicy.jsp" target=mainFrame>&nbsp;<font size=2>添加政策</font></A>
								</TD>
							</TR>
							...
							<TR height=20>
								...
								<TD><A class=menuChild
									onclick="javascript:window.close();"
									href="searchpolicyservlet" target=mainFrame>&nbsp;<font size=2>查询政策</font></A>
								</TD>
							</TR>
							<TR height=4>
								<TD colSpan=2></TD>
					...
					<TABLE id=child9 style="DISPLAY: none" cellSpacing=0 cellPadding=0 width=150 border=0>
						<TBODY>
							<TR height=20>
								...
								<TD><A class=menuChild
									onclick="javascript:window.close();"
									href="backlogout" target="_top">&nbsp;<font size=2>退出系统</font></A>
								</TD>
							</TR>
							<TR height=4>
								<TD colSpan=2></TD>
